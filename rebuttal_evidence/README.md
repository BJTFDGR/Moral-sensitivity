...
| Significance tests (McNemar / Wilcoxon / bootstrap) for Tables 2–4 contrasts | [results/significance.md](results/significance.md) | data/manifest.json (source files) | scripts/t4_significance.py |
